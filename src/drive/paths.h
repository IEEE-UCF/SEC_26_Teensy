...
#define BEACONX 9             ///< Beacon location X.
#define BEACONY 28.5          ///< Beacon location Y.
#define NORTH (0.5 * PI)      ///< Angular direction of North.
#define EAST 0.0              ///< Angular direction of East.
#define SOUTH (-0.5 * PI)     ///< Angular direction of South.
#define WEST PI               ///< Angular direction of West.
#define GEODX 50.0            ///< Field location of Geodinium Conatiner X.
#define MAXY 47.0             ///< Field location of Max Y
#define NEBX 23.0             ///< Field location Neodinium Conatiner X.
#define CENTERY (MAXY / 2.0)  ///< Center of field.
#define MAXX 95.0             ///< Field location of Max X
