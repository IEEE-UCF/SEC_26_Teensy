/*
Motor_GenericHBridge - Example implementation for Rotational HBridge with Enable Motor
...
class MOTOR_NFPGM25BL2838 : public Motor<RotationalMotor, EncoderType, RotationalMotorConstants, FourSpeedDirDirEn>
{
public:
    using Base = Motor<RotationalMotor, EncoderType, RotationalMotorConstants, FourSpeedDirDirEn>; // for convenience
