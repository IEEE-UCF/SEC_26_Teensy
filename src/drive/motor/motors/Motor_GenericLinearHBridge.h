...
class MOTOR_NFPGM25BL2838 : public Motor<LinearMotor, EncoderType, LinearMotorConstants, ThreeSpeedDirDir>
{
public:
    using Base = Motor<LinearMotor, EncoderType, LinearMotorConstants, ThreeSpeedDirDir>; // for convenience
